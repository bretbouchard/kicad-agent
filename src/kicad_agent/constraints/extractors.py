...
from kicad_agent.constraints.table import lookup_params
...
if TYPE_CHECKING:
    from kicad_agent.analysis.design_rules import DesignRuleReport
    from kicad_agent.analysis.intent_schemas import DesignIntent
    from kicad_agent.analysis.subcircuit_detector import Subcircuit
    from kicad_agent.analysis.topology_graph import CircuitTopology, TopologyEdge, TopologyNode
