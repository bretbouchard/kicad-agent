...
from kicad_agent.ops.repair_wires import SNAP_TOLERANCE  # noqa: F401

# Re-export NetPositionIndex for backward compatibility (tests patch via this path)
from kicad_agent.schematic_routing.net_extractor import NetPositionIndex  # noqa: F401

# Public API re-exports
from kicad_agent.ops.repair_wires import (  # noqa: F401
    break_wire_shorts,
    find_bridge_wires,
...
from kicad_agent.ops.repair_nets import (  # noqa: F401
    _check_orphan_count,
    _diff_net_snapshots,
    _is_power_net,
    _take_net_snapshot,
...
from kicad_agent.ops.repair_components import (  # noqa: F401
    fix_pin_type_mismatches,
    place_missing_units,
    update_symbols_from_library,
)
from kicad_agent.ops.repair_erc import (  # noqa: F401
    _checkpoint_ir,
    _restore_ir,
