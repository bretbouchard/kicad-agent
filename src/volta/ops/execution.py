...
def _check_concurrent_access(file_path: Path) -> None:
    ...
    Creates a ``.volta.lock`` file in the parent directory of the
...
CREATE_OP_TYPES = {"create_schematic", "create_pcb", "create_project", "create_symbol", "create_footprint", "convert_from_skidl", "import_symbol"}
...
from volta.ops.pre_analysis import _VALID_KICAD_EXTENSIONS
