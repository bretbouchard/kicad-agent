...
Usage:
    from volta.ops.swap_symbol import swap_symbol, embed_symbol
    from volta.ops.schema import SwapSymbolOp, EmbedSymbolOp
...
def swap_symbol(
    ...
    if op.library_path:
        ...
        if not already_embedded:
            from volta.ops.schema import EmbedSymbolOp
