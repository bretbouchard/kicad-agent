...
def _handle_sch_validate_footprint(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.handlers.schematic import _validate_footprint_impl
...
def _handle_validate_power_nets(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.validation_gates import validate_power_nets
...
def _handle_validate_schematic(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.validation_gates import validate_schematic_completeness
...
def _handle_parse_erc(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.erc_parser import parse_erc
...
def _handle_extract_violation_positions(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.erc_parser import extract_violation_positions
...
def _handle_detect_net_shorts(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.net_short_detector import detect_net_shorts
...
def _handle_infer_connectivity(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    from volta.schematic_routing.net_inference import infer_nets
    return infer_nets(
        sch_path=file_path,
        pin_map=op.pin_map,
...
def _handle_analyze_ground_topology(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.ground_topology import analyze_ground_topology
...
def _handle_generate_bom(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    ...
    """
    from volta.ops.handlers.pcb_bom import _handle_generate_bom as _bom_handler
...
def _handle_convert_to_skidl(op: Any, ir: SchematicIR, file_path: Path) -> dict[str, Any]:
    ...
    """
    from volta.circuit_ir import build_circuit, emit_build_py
