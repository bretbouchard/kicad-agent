...
def _handle_add_copper_zone(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.pcb_ops import add_copper_zone
...
def _handle_set_board_outline(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.pcb_ops import set_board_outline
...
def _handle_assign_net_class(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    from volta.ops.pcb_ops import assign_net_class
...
def _handle_auto_route(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    ...
    if op.length_match_pairs:
        ...
        from volta.routing.pathfinder import _path_length as calc_len
...
def _handle_route_diff_pair(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    ...
    from volta.routing.constraints import RoutingConstraints
    from volta.routing.diff_pair import route_differential_pair
...
def _handle_fill_gaps(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    ...
    from volta.analysis.gap_fill_engine import GapFillEngine
...
def _handle_import_ses(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    ...
    """
    from volta.routing.freerouting import import_ses_into_pcb
...
def _handle_auto_route_manhattan(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    ...
    """
    from volta.routing.manhattan import route_manhattan, segments_to_sexpr
    from volta.ops.pcb_raw_writer import PcbRawWriter
    ...
    from volta.routing.manhattan import NetOverride
...
def _handle_auto_place_zoned(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    ...
    from volta.generation.intent import ComponentSpec, NetSpec
    from volta.ops.pcb_raw_writer import PcbRawWriter
    from volta.placement.zone_partition import assign_to_zone, build_keepouts_from_zone
...
def _handle_apply_floor_plan(op: Any, ir: PcbIR, file_path: Path) -> dict[str, Any]:
    ...
    """
    from volta.floorplan import load_floor_plan, apply_floor_plan
