...
from volta.ops.handlers.schematic import register_schematic
...
# patch `volta.ops.executor.OperationExecutor` at the source module.
...
def _handle_place_components_sch(op: Any, ir: Any, file_path: Path) -> dict[str, Any]:
    ...
    from volta.schematic_autolayout import SugiyamaLayout, LayoutGraph
    from volta.schematic_autolayout import paper_sizes
    from volta.schematic_autolayout.layout_planner import (
...
def _park_ambiguous_by_uuid(
    ...
    from volta.schematic_autolayout.layout_planner import PageRegion
    placed_max_y = (
...
def _handle_auto_layout_sch(op: Any, ir: Any, file_path: Path) -> dict[str, Any]:
    ...
    from volta.schematic_autolayout.symbol_normalizer import (
    ...
    if split_result.promote_to_hierarchical:
        try:
            ...
            from volta.beads import beads_create  # type: ignore
            beads_create(
                title=(
