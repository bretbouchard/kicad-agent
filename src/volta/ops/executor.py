...
from volta.ops.handlers import (  # noqa: F401
    _SCHEMATIC_HANDLERS,
...
# Tests import these from volta.ops.executor for backward compatibility
from volta.ops.execution import (  # noqa: F401
...
class OperationExecutor:
    ...
    def execute_batch(self, ops: list[Operation]) -> dict[str, Any]:
        ...
        """
        from volta.ops.batch_executor import execute_batch as _execute_batch
