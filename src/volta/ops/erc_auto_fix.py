...
def _get_repair_function(repair_name: str) -> Any:
    ...
    if repair_name == "place_no_connects_from_erc":
        from volta.ops.repair_erc import place_no_connects_from_erc
        ...
        from volta.ops.repair_erc import add_junctions_at_labels
    ...
    for iteration in range(max_iterations):
        ...
        for repair_name in REPAIR_PRIORITY:
            ...
            try:
                ...
                if verify:
                    from volta.ops.repair_erc import _checkpoint_ir
                    from volta.ops.repair_nets import _take_net_snapshot
                ...
                try:
                    from volta.ops.repair_erc import _checkpoint_ir as _ckpt
                ...
                if scope_checkpoint is not None and inventory_before is not None:
                    ...
                    if wire_delta > 0:
                        ...
                        from volta.ops.repair_erc import _restore_ir
                ...
                if verify and snapshot_before is not None:
                    from volta.ops.repair_nets import (
                        _diff_net_snapshots,
...
def _deregister_parse_result(parse_result: Any) -> None:
    ...
    """
    from volta.ir.base import _ir_registry, _ir_registry_lock, _ir_finalizers
