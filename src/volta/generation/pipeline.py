...
Usage::
    ...
    from volta.generation.pipeline import generate_design, GenerationResult
...
def generate_design(
    ...
    if run_export:
        ...
        if pcb_path.exists():
            try:
                from volta.export import export_position
    ...
    if pcb_path.exists():
        try:
            from volta.export import get_board_statistics
