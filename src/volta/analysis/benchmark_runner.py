...
Usage::
    ...
    from volta.analysis.benchmark_runner import QwenTextAdapter
...
.. note::
   ...
   * :mod:`volta.analysis.benchmark_types` — Protocol, dataclasses,
     scoring helpers.
   * :mod:`volta.analysis.benchmark_adapters` — ``QwenTextAdapter``
   ...
   * This module — ``BenchmarkRunner`` orchestrator only.
   ...
   (``from volta.analysis.benchmark_runner import ...``) continue
   to work unchanged.
"""
...
from volta.analysis.benchmark_adapters import (
    GemmaVisionAdapter,
    QwenTextAdapter,
)
from volta.analysis.benchmark_types import (
    BenchmarkReport,
    CategoryScore,
    ModelAdapter,
    TaskResult,
...
from volta.analysis.benchmark_adapters import _GEMMA_MODEL_ID, _GEMMA_MMPROJ
