...
from volta.generation.placement import PlacementEngine
from volta.placement.graph import PlacementGraph, netlist_to_placement_graph
from volta.placement.interactive import ConstraintSet, interactive_placement
from volta.placement.scoring import PlacementScorer, compute_hpwl_score
...
class HybridPlacementEngine:
    ...
    def place(self, request: PlacementRequest) -> PlacementOutput:
        ...
        if has_any:
            from volta.placement.packing import resolve_overlaps
    ...
    def _place_rule_based(
        ...
        from volta.placement.graph import _estimate_size_inline
