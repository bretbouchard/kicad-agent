...
Usage::
    ...
    from volta.placement.training.train import PlacementTrainer, PlacementTrainConfig
...
class PlacementTrainer:
    ...
    def train(self, dataset: Any) -> dict:
        ...
        from volta.placement.training.dataset import PlacementDataset
    ...
    def _forward_and_score(
        ...
        from volta.placement.training.reward import placement_reward
