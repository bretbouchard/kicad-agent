...
Usage:
    from volta.training.sft import convert_chains_to_chatml, filter_and_split

    samples = convert_chains_to_chatml(Path("training_output/chains_100k.jsonl"))
"""

from volta.training.sft.converter import ChatMLSample, convert_chains_to_chatml
