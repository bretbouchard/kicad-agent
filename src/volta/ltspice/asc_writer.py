...
from volta.ltspice.asc_parser import ASY_STUBS_DIR
from volta.ltspice.sim_commands import SimulationCommand, serialize_sim_command
...
class AscWriter:
    ...
    def _add_component(
        ...
        if value:
            # spicelib renamed _attributes → attributes (OrderedDict on Component)
