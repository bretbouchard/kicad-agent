...
_CATEGORY_DEFAULTS: dict[str, list[tuple[str, str | None]]] = {
    ...
    "component": [
        ...
        ("volta_reference.md", "Editing object properties"),
    ],
    # Wire and connection operations
    "wire": [
        ("volta_reference.md", "Electrical connections between sheets"),
    ],
    # Net operations
    "net": [
        ("volta_reference.md", "Electrical connections between sheets"),
    ...
    "reference": [
        ("volta_reference.md", "Reference designators and symbol annotation"),
    ],
    # Footprint operations
    "footprint": [
        ("pcb_editor_reference.md", "Working with footprints"),
        ("volta_reference.md", "Assigning Footprints in Symbol Properties"),
    ],
    ...
    # Sheet operations
    "sheet": [
        ("volta_reference.md", "Forward and back annotation"),
    ],
...
_PER_OP_OVERRIDES: dict[str, list[tuple[str, str | None]]] = {
    ...
    "snap_components_to_grid": [
        ("volta_reference.md", "Grids and snapping"),
        ("kicad_docs.md", "Schematic Setup"),
    ],
