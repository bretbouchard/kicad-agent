...
from volta.manufacturing.board_spec import BoardSpec, load_board_spec
...
def export_handoff(
    ...
    from volta.validation.erc_drc import run_drc, run_erc
    ...
    try:
        ...
        from volta.validation.gates.manufacturing_manifest import validate_manifest
