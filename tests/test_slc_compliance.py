...
class TestOperationCountConsistency:
    ...
    def test_schema_op_count(self) -> None:
        ...
        # 49 original minus AddBusOp and RemoveBusOp = 47, plus 4 remove ops + 1 query op + 1 footprint op + 3 sheet ops + 1 cross-file op = 57
        assert count == 57, f"Expected 57 Op classes, found {count}"
