...
#
# volta-daemon.spec — PyInstaller spec for the bundled Python daemon.
#
...
# Build:
#   cd macos-app/daemon
#   pyinstaller --noconfirm volta-daemon.spec
#
# Output:
#   macos-app/daemon/dist/volta-daemon/volta-daemon  (executable)
#   macos-app/daemon/dist/volta-daemon/_internal/         (Python + libs)
#
...
if __name__ == "__main__":
    sys.stdout.write("[volta-daemon.spec] Analysis ready\n")
