...
```python
.venv/bin/python -c "from volta.ops.registry import validate_registry_completeness; r=validate_registry_completeness(); assert set(['build_create','build_list','build_show']) not in set(r['missing_from_registry'])"
```
