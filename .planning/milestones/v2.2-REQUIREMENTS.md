...
- [x] **LLM-11**: kicad-agent CLI `analyze` subcommand and Python API `generate_analysis(pcb_path)` expose fine-tuned model
...
- [x] **PKG-01**: New CLI entry point `kicad-agent-edit` registered in `pyproject.toml`
